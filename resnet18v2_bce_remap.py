...
if __name__ == "__main__":
    ...
    save_path = f"resnet18_{condition}_{timestamp}.pt"
    torch.save(model.state_dict(), save_path)
    torch.save(model[0].state_dict(), "resnet18_{condition}_feature_extractor.pt")
...
# Example usage:
# predict_image(model, "dataset/good/test.jpg", transform, task=task_type)
